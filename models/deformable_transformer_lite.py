...
from .utils_lite import gen_encoder_output_proposals, MLP, _get_activation_fn, gen_sineembed_for_position
from models.ops.modules import MSDeformAttnLite as MSDeformAttn
...
def build_deformable_transformer(args):
    ...
    if args.decoder_layer_noise:
        from .utils_lite import RandomBoxPerturber
