...
python -u main_open_world.py \
    ...
    --train_set 'owod_t1_5classes_train' --test_set 'owod_all_task_test' --epochs 41\
    --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3 --batch_size 2\
    --wandb_project "PROB_CHU" --wandb_name "${WANDB_NAME}_t1_chu" --exemplar_replay_selection --exemplar_replay_max_length 850\
...
#     --train_set 'owod_t2_train' --test_set 'owod_all_task_test' --epochs 1\
...
#     --pretrain "${EXP_DIR}/t1/checkpoint0000.pth" --lr 2e-5\
#     ${PY_ARGS}
    

# # CL after t2 (fine_tuning)
# PY_ARGS=${@:1}
# python -u main_open_world.py \
#     --output_dir "${EXP_DIR}/t2_ft" --dataset TOWOD --PREV_INTRODUCED_CLS 20 --CUR_INTRODUCED_CLS 20 \
#     --train_set "${WANDB_NAME}/learned_owod_t2_ft" --test_set 'owod_all_task_test' --epochs 1 --lr_drop 40\
#     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
#     --wandb_name "${WANDB_NAME}_t2_ft"\
#     --pretrain "${EXP_DIR}/t2/checkpoint0000.pth"\
#     ${PY_ARGS}
...
#     --train_set 'owod_t3_train' --test_set 'owod_all_task_test' --epochs 1\
...
#     --pretrain "${EXP_DIR}/t2_ft/checkpoint0000.pth" --lr 2e-5 \
#     ${PY_ARGS}
...
#     --train_set "${WANDB_NAME}/learned_owod_t3_ft" --test_set 'owod_all_task_test' --epochs 1 --lr_drop 35\
#     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
#     --wandb_name "${WANDB_NAME}_t3_ft"\
#     --pretrain "${EXP_DIR}/t3/checkpoint0000.pth"\
#     ${PY_ARGS}
...
#     --train_set 'owod_t4_train' --test_set 'owod_all_task_test' --epochs 1 \
#     --model_type 'prob' --obj_loss_coef 8e-4 --freeze_prob_model --obj_temp 1.3\
...
#     --pretrain "${EXP_DIR}/t3_ft/checkpoint0000.pth" --lr 2e-5\
#     ${PY_ARGS}
...
#     --train_set "${WANDB_NAME}/learned_owod_t4_ft" --test_set 'owod_all_task_test' --epochs 1 --lr_drop 50\
#     --model_type 'prob' --obj_loss_coef 8e-4 --obj_temp 1.3\
#     --wandb_name "${WANDB_NAME}_t4_ft"\
#     --pretrain "${EXP_DIR}/t4/checkpoint0000.pth" \
#     ${PY_ARGS}